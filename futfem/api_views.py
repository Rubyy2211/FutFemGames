...
def jugadoraxid(request):
    ...
    data = {
        ...
        "Imagen": construir_url_imagen(imagen),
        "Apodo": j.Apodo,
        "Nombre": j.Nombre,
...
def jugadoras_por_equipo_y_temporada(request):
    ...
    for fila in filas:
        ...
        equipo_obj = {
            ...
            "escudo": "static/img/retirada.svg" if es_retirada else construir_url_imagen(escudo_path),
            "color": fila[14] if fila[14] else "#808080",
            "liga_id": fila[15],
